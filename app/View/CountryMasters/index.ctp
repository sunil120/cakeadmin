<script type="text/javascript" charset="utf-8">
    var datatableConfig = {
        ...
        "search": {
            'active': true,
            "mode": 'remote',
            'url': "<?php echo Router::url('/', true); ?>country_masters/ajax_fetch", //Required if mode is remote
        },
        "order": {
            "mode": 'remote',
            "url": "<?php echo Router::url('/', true); ?>country_masters/ajax_fetch"
        },
        "remove": {
            "active": true,
            "withEdit": true,
            "mode": 'remote',
            "formSubmitAction": '<?php echo Router::url('/', true); ?>country_masters/delete',
            "submitMethod": 'POST',
        ...
        "add": {
            ...
            "showButton": true,
            "action": '<?php echo Router::url('/', true); ?>country_masters/add'
        },
        "editSingle": {
            "active": '<?php echo $editAccess; ?>',
            "showButton": true,
            "action": '<?php echo Router::url('/', true); ?>country_masters/edit'
        },
        "deleteSingle": {
            "active": '<?php echo $deleteAccess; ?>',
            "showButton": true,
            "action": '<?php echo Router::url('/', true); ?>country_masters/delete'
        },
        "exportDATA": {
            "action": '<?php echo Router::url('/', true); ?>country_masters/export_fetch',
        ...
        "advancefilter": {
            ...
            "action": '<?php echo Router::url('/', true); ?>country_masters/ajax_fetch', // ACTION
            "fields": {
