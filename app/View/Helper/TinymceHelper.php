...
//        $tinyoptions["setup"] = "function(editor) {editor.on('focus', function() { console.log('focus'); } }";
        $json = $this->Js->object($tinyoptions);

        // Replace the functions
        $json = str_replace($replace_keys, $value_arr, $json);

        // Trigger focus event of editor
        $json = rtrim($json, "}");
        $json .= ", \"setup\":function(editor) {editor.on('focus', function() { $(\".custom-tooltip\").remove(); }); }";
        $json .= "}";
    ...
    */
    function textarea($fieldName, $options = array(), $tinyoptions = array(), $preset = null){
        ...
        $default = array('class' => 'form-control', 'label' => false, 'type' => 'textarea');
